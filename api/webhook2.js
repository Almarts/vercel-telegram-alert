export default async function handler(req, res) {
  ...
  const BOT_TOKEN_1 = process.env.WEBHOOK2_TELEGRAM_BOT_TOKEN;
  const CHAT_ID_1   = process.env.WEBHOOK2_TELEGRAM_CHAT_ID;
  const BOT_TOKEN_2 = process.env.WEBHOOK2_TELEGRAM_BOT_TOKEN_2;
  const CHAT_ID_2   = process.env.WEBHOOK2_TELEGRAM_CHAT_ID_2;
  const THREAD_ID_2 = process.env.WEBHOOK2_TELEGRAM_THREAD_ID_2;
